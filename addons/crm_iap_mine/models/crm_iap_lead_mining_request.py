...
DEFAULT_ENDPOINT = 'http://localhost:8069/iap/crm_iap_lead_mining_request'
...
class CRMLeadMiningRequest(models.Model):
    ...
    def _iap_contact_mining(self, params, timeout=300):
        # Set the endpoint to your local Odoo instance's base URL
        # or to a custom parameter that points to your local service.
        # We remove the hardcoded reference to external services.
        
        # You can get the base URL from the system parameters
        base_url = self.env['ir.config_parameter'].sudo().get_param('web.base.url')
        
        endpoint = f'{base_url}/iap/clearbit/2/lead_mining_request'
